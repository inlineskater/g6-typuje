...
const ENGINE_VERSION = 'office_grand_prix_v5';
...
const GRIP_NUM_ROAD = 2;
const GRIP_DEN_ROAD = 5;
...
function assertSourceContracts() {
  ...
  assertContains(clientSource, 'if (car.boostTicks > 0) velocity = Math.floor(velocity * 140 / 100);', 'client turbo floor order');
