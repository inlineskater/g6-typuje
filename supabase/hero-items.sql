...
CREATE TABLE IF NOT EXISTS public.hero_item_defs (
  ...
  effect_game  text CHECK (effect_game IS NULL OR effect_game IN ('roulette','slots','whack_boss','bug_jumper','flappy_pants','snake','poker','tavern','global')),
...
ALTER TABLE public.hero_item_defs ADD CONSTRAINT hero_item_defs_effect_game_check
  CHECK (effect_game IS NULL OR effect_game IN ('roulette','slots','whack_boss','bug_jumper','flappy_pants','snake','poker','tavern','global'));
